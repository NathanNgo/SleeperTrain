...
signal add_division_to_carriage(postition: Vector2, level: int, carriage_index: int)
signal remove_division_from_carriage(position: Vector2, level: int, carriage_index: int)
signal remove_all_divisions_from_carriage(carriage_index: int)
