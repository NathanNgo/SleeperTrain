...
func get_chunked_full_path_from_edge_path(starting_point: Vector2, edge_path: Array[GridRailwayEdge]) -> Variant:
	...
	for edge in edge_path:
		...
		var edge_points = normalize_edge_direction(previous_edge_last_point, edge.edge_points)
